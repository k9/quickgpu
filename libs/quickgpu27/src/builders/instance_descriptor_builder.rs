...
impl<CS: State> InstanceDescriptorBuilder<CS> {
    ...
    pub fn backends(self, backends: wgpu::Backends) -> InstanceDescriptorBuilder<SetBackends<CS>>
    where
    ...
    pub fn flags(self, flags: wgpu::InstanceFlags) -> InstanceDescriptorBuilder<SetFlags<CS>>
    where
