...
macro_rules! _create_binds_v28 {
    ($binds_name:ident, $($name:ident),*) => {
        ...
        impl $binds_name {
            #[builder]
            pub fn new(
                $($name: impl quickgpu::v28::NestedBinding),*
            ) -> $binds_name {
                $binds_name {
                    $($name: $name.unnest()),*
                }
            ...
            pub fn layout(
                &self,
                device: &quickgpu::wgpu_28::Device,
            ) -> quickgpu::wgpu_28::BindGroupLayout {
            ...
            pub fn group<'a>(
                &self,
                #[builder(finish_fn)]
                with_layout: &'a quickgpu::wgpu_28::BindGroupLayout,
                #[builder(finish_fn)]
                with_device: &quickgpu::wgpu_28::Device,
                $($name: quickgpu::wgpu_28::BindingResource<'a>),*,
            ) -> quickgpu::wgpu_28::BindGroup {
