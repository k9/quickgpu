...
pub trait NestedExtent3d {
    fn unnest(self) -> wgpu_29::Extent3d;
}
impl NestedExtent3d for wgpu_29::Extent3d {
    fn unnest(self) -> wgpu_29::Extent3d {
        self
    }
}
