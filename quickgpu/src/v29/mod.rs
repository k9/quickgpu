...
mod create_binds;
#[doc(inline)]
pub use crate::_arr_option_v29 as arr_option;
#[doc(inline)]
pub use crate::_arr_v29 as arr;
#[doc(inline)]
pub use crate::_create_binds_v29 as create_binds;
mod render_pass_builder {
    use super::builders::render_pass_descriptor_builder::*;
    use wgpu_29::CommandEncoder;
    impl<'a, CS: state::IsComplete> RenderPassDescriptorBuilder<'a, CS> {
        pub fn begin_with(self, encoder: &'a mut CommandEncoder) -> wgpu_29::RenderPass<'a> {
...
pub struct Binding {
    pub binding: u32,
    pub visibility: wgpu_29::ShaderStages,
    pub ty: wgpu_29::BindingType,
...
#[doc(inline)]
pub use builders::cooperative_matrix_properties;
