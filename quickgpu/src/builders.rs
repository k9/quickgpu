...
pub mod builder_depth_stencil_state {
    ...
    impl<RFormat, RDepthWriteEnabled, RDepthCompare, RStencil, RBias>
        ...
        for DepthStencilStateBuilder<RFormat, RDepthWriteEnabled, RDepthCompare, RStencil, RBias>
    where
        RFormat: Resolve<wgpu::TextureFormat>,
        RDepthWriteEnabled: Resolve<bool>,
        RDepthCompare: Resolve<wgpu::CompareFunction>,
...
pub mod builder_texture_descriptor {
    ...
    impl<RLabel, RSize, RMipLevelCount, RSampleCount, RDimension, RFormat, RUsage, RViewFormats>
        TextureDescriptorBuilder<
            RLabel,
            RSize,
            RMipLevelCount,
...
pub mod builder_fragment_state {
    ...
    impl<'a, RModule, REntryPoint, RCompilationOptions, RTargets> Nested<wgpu::FragmentState<'a>>
...
pub mod builder_render_pass_depth_stencil_attachment {
    ...
    impl<'tex, RView, RDepthOps, RStencilOps> Nested<wgpu::RenderPassDepthStencilAttachment<'tex>>
