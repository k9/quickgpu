...
pub fn backend_options(
    #[builder(default=wgpu::GlBackendOptions::default())] gl: impl Nested<wgpu::GlBackendOptions>,
...
pub fn pipeline_layout_descriptor<'a>(
    ...
    #[builder(default)] push_constant_ranges: &'a [impl Nested<wgpu::PushConstantRange>],
) -> wgpu::PipelineLayoutDescriptor<'a> {
    wgpu::PipelineLayoutDescriptor {
        label: label,
        bind_group_layouts: bind_group_layouts,
        push_constant_ranges: push_constant_ranges.unnest(),
    }
}
...
pub fn render_pass_descriptor<'a>(
    #[builder(default)] label: wgpu::Label<'a>,
    #[builder(default)] color_attachments: &'a [Option<
        impl Nested<wgpu::RenderPassColorAttachment<'a>>,
    >],
    ...
    wgpu::RenderPassDescriptor {
        label: label,
        color_attachments: color_attachments.unnest(),
...
pub fn fragment_state<'a>(
    ...
    targets: &'a [Option<impl Nested<wgpu::ColorTargetState>>],
) -> wgpu::FragmentState<'a> {
    wgpu::FragmentState {
        module: module,
        entry_point: entry_point,
        compilation_options: compilation_options.unnest(),
        targets: targets.unnest(),
    }
}
...
pub fn bind_group_descriptor<'a>(
    ...
    entries: &'a [impl Nested<wgpu::BindGroupEntry<'a>>],
) -> wgpu::BindGroupDescriptor<'a> {
    wgpu::BindGroupDescriptor {
        label: label,
        layout: layout,
        entries: entries.unnest(),
    }
}
...
pub fn vertex_state<'a>(
    ...
    entry_point: Option<&'a str>,
    compilation_options: impl Nested<wgpu::PipelineCompilationOptions<'a>>,
    buffers: &'a [impl Nested<wgpu::VertexBufferLayout<'a>>],
) -> wgpu::VertexState<'a> {
    wgpu::VertexState {
        module: module,
        entry_point: entry_point,
        compilation_options: compilation_options.unnest(),
        buffers: buffers.unnest(),
    }
}
...
pub fn vertex_buffer_layout<'a>(
    ...
    attributes: &'a [impl Nested<wgpu::VertexAttribute>],
) -> wgpu::VertexBufferLayout<'a> {
    wgpu::VertexBufferLayout {
        array_stride: array_stride,
        step_mode: step_mode,
        attributes: attributes.unnest(),
    }
}
...
pub fn bind_group_layout_descriptor<'a>(
    label: wgpu::Label<'a>,
    entries: &'a [impl Nested<wgpu::BindGroupLayoutEntry>],
