...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn texel_copy_texture_info<T>(
    #[builder(into)] texture: T,
    #[builder(into)] mip_level: u32,
    #[builder(default, into)] origin: Origin3d,
    #[builder(default, into)] aspect: TextureAspect,
) -> TexelCopyTextureInfo<T> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn request_adapter_options<S>(
    #[builder(default, into)] power_preference: PowerPreference,
    #[builder(into)] force_fallback_adapter: bool,
    #[builder(into)] compatible_surface: Option<S>,
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn buffer_descriptor<L>(
    #[builder(into)] label: L,
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn texel_copy_buffer_info<B>(
    #[builder(into)] buffer: B,
    #[builder(default, into)] layout: TexelCopyBufferLayout,
) -> TexelCopyBufferInfo<B> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn query_set_descriptor<L>(
    #[builder(into)] label: L,
    #[builder(into)] ty: QueryType,
    #[builder(into)] count: u32,
) -> QuerySetDescriptor<L> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn shader_module_descriptor_hlsl<'a, L>(
    #[builder(into)] entry_point: String,
    #[builder(into)] label: L,
    #[builder(into)] num_workgroups: (u32, u32, u32),
    #[builder(into)] source: &'a str,
) -> ShaderModuleDescriptorHlsl<'a, L> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn shader_module_descriptor_msl<'a, L>(
    #[builder(into)] entry_point: String,
    #[builder(into)] label: L,
    #[builder(into)] num_workgroups: (u32, u32, u32),
    #[builder(into)] source: Cow<'a, str>,
) -> ShaderModuleDescriptorMsl<'a, L> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn surface_configuration<V>(
    ...
    #[builder(into)] view_formats: V,
) -> SurfaceConfiguration<V> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn shader_module_descriptor_spir_v<'a, L>(
    #[builder(into)] label: L,
    #[builder(into)] source: Cow<'a, [u32]>,
) -> ShaderModuleDescriptorSpirV<'a, L> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn create_tlas_descriptor<L>(
    #[builder(into)] label: L,
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn texture_view_descriptor<L>(
    #[builder(into)] label: L,
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn render_bundle_descriptor<L>(#[builder(into)] label: L) -> RenderBundleDescriptor<L> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn command_encoder_descriptor<L>(#[builder(into)] label: L) -> CommandEncoderDescriptor<L> {
...
*/
#[bon::builder(state_mod(vis = "pub(crate)"))]
pub fn create_blas_descriptor<L>(
    #[builder(into)] label: L,
    #[builder(into)] flags: AccelerationStructureFlags,
    #[builder(into)] update_mode: AccelerationStructureUpdateMode,
) -> CreateBlasDescriptor<L> {
