...
#[doc = "\nReturns [ShaderModuleDescriptorPassthroughBuilder] for building [`wgpu_27::ShaderModuleDescriptorPassthrough`]\n        \nSet all required fields and any optional fields, then call `build()`.\n\nBuilder field setters:\n  - [entry_point](ShaderModuleDescriptorPassthroughBuilder::entry_point) Optional, defaults to `\"\".into()`\n  - [num_workgroups](ShaderModuleDescriptorPassthroughBuilder::num_workgroups) Optional, defaults to `(0,0,0)`\n  - [runtime_checks](ShaderModuleDescriptorPassthroughBuilder::runtime_checks) Optional, defaults to [wgpu_27::ShaderRuntimeChecks::unchecked()]\n  - [spirv](ShaderModuleDescriptorPassthroughBuilder::spirv) Optional, defaults to `None`\n  - [dxil](ShaderModuleDescriptorPassthroughBuilder::dxil) Optional, defaults to `None`\n  - [msl](ShaderModuleDescriptorPassthroughBuilder::msl) Optional, defaults to `None`\n  - [hlsl](ShaderModuleDescriptorPassthroughBuilder::hlsl) Optional, defaults to `None`\n  - [glsl](ShaderModuleDescriptorPassthroughBuilder::glsl) Optional, defaults to `None`\n  - [wgsl](ShaderModuleDescriptorPassthroughBuilder::wgsl) Optional, defaults to `None`\n"]
...
pub trait IsSetRuntimeChecks {
    fn get(self) -> wgpu_27::ShaderRuntimeChecks;
}
impl IsSetRuntimeChecks for RuntimeChecksEmpty {
    fn get(self) -> wgpu_27::ShaderRuntimeChecks {
        wgpu_27::ShaderRuntimeChecks::unchecked()
    }
}
pub struct RuntimeChecksValue(pub wgpu_27::ShaderRuntimeChecks);
...
impl<'a, CS: State<'a>> ShaderModuleDescriptorPassthroughBuilder<'a, CS> {
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::entry_point]. Optional, defaults to `\"\".into()`.\n"]
    pub fn entry_point(
        self,
        entry_point: String,
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::label]. Optional, defaults to `None`.\n"]
    pub fn label(
        self,
        label: wgpu_27::Label<'a>,
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::num_workgroups]. Optional, defaults to `(0,0,0)`.\n"]
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::runtime_checks]. Optional, defaults to [wgpu_27::ShaderRuntimeChecks::unchecked()].\n"]
    pub fn runtime_checks(
        self,
        runtime_checks: impl Nested<wgpu_27::ShaderRuntimeChecks>,
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::spirv]. Optional, defaults to `None`.\n"]
    pub fn spirv(
        self,
        spirv: Cow<'a, [u32]>,
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::dxil]. Optional, defaults to `None`.\n"]
    pub fn dxil(
        self,
        dxil: Cow<'a, [u8]>,
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::msl]. Optional, defaults to `None`.\n"]
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::hlsl]. Optional, defaults to `None`.\n"]
    pub fn hlsl(
        self,
        hlsl: Cow<'a, str>,
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::glsl]. Optional, defaults to `None`.\n"]
    pub fn glsl(
        self,
        glsl: Cow<'a, str>,
    ...
    #[doc = "Setter for [wgpu_27::ShaderModuleDescriptorPassthrough::wgsl]. Optional, defaults to `None`.\n"]
    pub fn wgsl(
        self,
        wgsl: Cow<'a, str>,
...
impl<'a, CS: Complete<'a>> ShaderModuleDescriptorPassthroughBuilder<'a, CS> {
    pub fn build(self) -> wgpu_27::ShaderModuleDescriptorPassthrough<'a> {
        wgpu_27::ShaderModuleDescriptorPassthrough {
...
mod tests {
    ...
    pub fn test_default() {
        assert_eq!(
            ...
            format!(
                "{:#?}",
                wgpu_27::ShaderModuleDescriptorPassthrough::default()
            ),
        );
    }
}
